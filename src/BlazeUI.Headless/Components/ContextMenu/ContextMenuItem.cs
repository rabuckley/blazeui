...
public class ContextMenuItem : BlazeElement<ContextMenuItemState>
{
    ...
    protected override ContextMenuItemState GetCurrentState() => new(IsHighlighted, Disabled);
    ...
    private async Task HandleClick()
    {
        ...
        if (CloseOnClick) await Context.Close();
    }
...
public readonly record struct ContextMenuItemState(bool Highlighted, bool Disabled);
