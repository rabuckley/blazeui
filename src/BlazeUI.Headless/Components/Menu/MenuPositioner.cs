...
public class MenuPositioner : BlazeElement<MenuPositionerState>
{
    ...
    {
        // Propagate placement to context so MenuPopup can emit data-side/data-align.
        Context.PlacementSide = PlacementHelper.ToDataSide(PlacementHelper.ToPlacement(Side, Align));
        Context.PlacementAlign = PlacementHelper.ToDataAlign(PlacementHelper.ToPlacement(Side, Align));
    }

    protected override string DefaultTag => "div";
    protected override MenuPositionerState GetCurrentState() => new(
    ...
    {
        // data-open, data-closed match Base UI's MenuPositionerDataAttributes (popupStateMapping).
...
public readonly record struct MenuPositionerState(string Side, string Align);
